...
const quiz = [
  {
question: '<b>' + 'From the alternatives lettered A to D, choose the one which most suitably completes each sentence. ' + '</b>' + '<br />' + '<br />' + ' He is _____ poor that he cannot pay his bills.',
options: ['so',
 'too',
 'very',
 'rather'],
...
question: '<b>' + 'From the list of words lettered A to D, choose the one that correctly answers each question or completes the sentence.' + '</b>' + '<br/>' + '<i>' + 'Extract:' + '</i>' + '<br />' + 'The sudden change in the weather frightened Araba.' + '<br />' + 
...
'The booming voice of thunder was intimidating.' + '<br />' +
'Lightning flashed shards of light from his formidable torch.' + '<br />' + 
'Araba was a cornered rat.' + '<br />' + '<br />' + '<i>' + ' \'Lightning flashed___light from___torch.\'' + '</i>' + 'is an example of _____',
